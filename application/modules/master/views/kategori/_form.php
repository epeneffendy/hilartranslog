<?php
$link = 'master/kategori/create';
if (!$isNewRecord) {
    $link = 'master/kategori/update';
}
        ...
        <div class="card card-info">
            ...
            <form class="form-horizontal" method="POST" action="<?php echo base_url($link); ?>"
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label for="input_email" class="col-sm-2 col-form-label">Keterangan</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" id="keterangan" name="keterangan"
                                   value="<?= (!$isNewRecord) ? $data->keterangan : '' ?>" placeholder="keterangan">
                        </div>
                    </div>
                    ...
                    <div class="card-footer">
                        <button type="submit"
                                class="btn btn-info float-right"><?= ($isNewRecord) ? 'Create Kategori' : 'Update Kategori' ?></button>
                    </div>
            </form>
